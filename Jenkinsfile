    ...
    stages {
        stage('Get Source') {
            steps {
                ...
                script {
                    ...
                    repo_name = '0925113309139.dkr.ecr.cn-northwest-1.amazonaws.com.cn'
        ...
        stage('Push Image') {
            steps {
                ...
                withDockerRegistry(credentialsId: 'ecr:cn-northwest-1:ecr-repo', url: 'https://092513309139.dkr.ecr.cn-northwest-1.amazonaws.com.cn/gitops-app') {
